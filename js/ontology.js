...
(function() {
  ...
  Ontology = (function() {
    ...
    function Ontology(owl_parser) {
      this.annotations = owl_parser.annotation_parser.models;
      this.classes = owl_parser.class_parser.models;
      this.individuals = owl_parser.individual_parser.models;
      this.object_properties = owl_parser.object_property_parser.models;
      this.data_properties = owl_parser.data_property_parser.models;
      this.data_types = owl_parser.data_type_parser.models;
  ...
  BaseParser = (function() {
    ...
    BaseParser.prototype._get_fix_bug_iri = function(iri) {
      var reg;
      if (!iri) {
        return null;
      }
  ...
  AnnotationParser = (function(_super) {
    ...
    AnnotationParser.prototype.get_model_by_iri = function(bug_iri) {
      ...
      ans = this.models.filter(function(an) {
        return an.iri === iri;
      });
      an = ans[0];
      if (!!an) {
  ...
  ClassParser = (function(_super) {
    ...
    ClassParser.prototype.get_model_by_iri = function(bug_iri) {
      var clazz, iri, models,
        _this = this;
      iri = this._get_fix_bug_iri(bug_iri);
      models = this.models.filter(function(clazz) {
  ...
  DataPropertyParser = (function(_super) {

    __extends(DataPropertyParser, _super);
    ...
    DataPropertyParser.prototype.get_model_by_iri = function(bug_iri) {
      var dp, dps, iri,
        _this = this;
      iri = this._get_fix_bug_iri(bug_iri);
      dps = this.models.filter(function(dp) {
        return dp.iri === iri;
      });
      dp = dps[0];
      if (!!dp) {
    ...
    DataPropertyParser.prototype._build_model = function(iri) {
      ...
      this.models.push(data_property);
  ...
  DataTypeParser = (function(_super) {

    __extends(DataTypeParser, _super);
    ...
    DataTypeParser.prototype.get_model_by_iri = function(bug_iri) {
      var dt, dts, iri,
        _this = this;
      iri = this._get_fix_bug_iri(bug_iri);
      dts = this.models.filter(function(dt) {
        return dt.iri === iri;
      });
      dt = dts[0];
      if (!!dt) {
  ...
  IndividualParser = (function(_super) {

    __extends(IndividualParser, _super);
    ...
    IndividualParser.prototype.get_model_by_iri = function(bug_iri) {
      var iri, models,
        _this = this;
      iri = this._get_fix_bug_iri(bug_iri);
      models = this.models.filter(function(indi) {
        return indi.iri === iri;
      });
      return models[0];
    };
  ...
  ObjectPropertyParser = (function(_super) {

    __extends(ObjectPropertyParser, _super);
